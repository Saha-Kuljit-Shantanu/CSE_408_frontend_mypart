...
<div class = "mt-12 ">
    ...
    <div class = "flex flex-row space-x-10 ">
        ...
        <div class = "text-lg right-72 font-bold fixed">
            
            { #if username === undefined } <Button id="sign-up" shadow color="dark" on:mouseenter = { () =>  showCard("SignUp","Want to Register?") } on:click = { () => signup() } > Sign Up </Button> 
